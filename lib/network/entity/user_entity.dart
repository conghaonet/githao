...
class UserEntity {
	...
	UserEntity({this.gistsUrl, this.reposUrl, this.followingUrl, this.bio, this.createdAt, this.login, this.type, this.blog, this.subscriptionsUrl,
		this.updatedAt, this.siteAdmin, this.company, this.id, this.publicRepos, this.gravatarId, this.email, this.organizationsUrl, this.hireable,
		...
		this.htmlUrl, this.following, this.name, this.location, this.nodeId, this.privateGists, this.totalPrivateRepos, this.ownedPrivateRepos,
