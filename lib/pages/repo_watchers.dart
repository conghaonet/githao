...
class RepoWatchersPage extends BaseGridWidget {
  static const ROUTE_NAME = "/repo_watchers";
  final String repoFullName;
  RepoWatchersPage(this.repoFullName, {Key key}): super(crossAxisCount: 2, childAspectRatio: 2, key: key);

  @override
  _RepoWatchersPageState createState() => _RepoWatchersPageState();
}

class _RepoWatchersPageState extends BaseGridWidgetState<RepoWatchersPage, UserEntity> {
